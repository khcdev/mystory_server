...
exports.projModify = async(req, res) => {
    var targetData  = { proj_name:req.body.name, proj_role:req.body.role, proj_startDate:req.body.startDate, proj_endDate:req.body.endDate, proj_des:req.body.des, proj_git:req.body.git };
    let id = req.body.id;
